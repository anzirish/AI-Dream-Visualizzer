...
const DreamCard: React.FC<DreamCardProps> = ({ dream, showDelete = false, onDelete }) => {
  ...
  return (
    <Link to={`/dream/${dream.id}`}>
      <div 
        className="group relative bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden hover:shadow-2xl hover:border-purple-200 transition-all duration-300 transform hover:-translate-y-1"
      ...
      >
        ...
        <div className="p-6 relative z-20">
          ...
          <div className="flex items-start justify-between mb-3 gap-3">
            <h3 className="text-xl font-bold text-gray-900 flex-1 line-clamp-2 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-purple-600 group-hover:bg-clip-text transition-all duration-300">
              {dream.title}
            </h3>
          ...
          {/* Story Section */}
          <div className="relative bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-xl p-4 border border-purple-100 shadow-inner overflow-hidden group-hover:shadow-md transition-shadow duration-300">
            {/* Decorative elements */}
            <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-blue-200/30 to-purple-200/30 rounded-full blur-2xl -translate-y-8 translate-x-8" />
            <div className="absolute bottom-0 left-0 w-20 h-20 bg-gradient-to-tr from-pink-200/30 to-purple-200/30 rounded-full blur-2xl translate-y-6 -translate-x-6" />
