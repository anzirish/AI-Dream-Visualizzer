      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-white">DreamForge</span>
          </Link>
          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? (
              ...
              <div className="flex items-center space-x-3">
                ...
                <Link to="/signup">
                  <button className="px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 rounded-md transition-colors">
                    Sign Up
                  </button>
                </Link>
              </div>
